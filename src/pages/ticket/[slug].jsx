                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 col-12">
                        <div className="blog-details-text-area details-text-area pr-20">
                            ...
                            <div className="blog-quote">
                                <h5><i className="fas fa-quote-left"></i><span>Cancellation Reason</span> <i className="fas fa-quote-right"></i></h5>
                                <p>Got urgent work</p>
                            </div>
                        </div>
                        ...
                        <div className="sidebar-area pt-30">
                            <div className="sidebar-card recent-news">
                                ...
                                <div className="recent-news-card">
                                    ...
                                    <h5><a href="blog-details.html">Delhi to Bengaluru</a></h5>
                                    <p>5th Jun 2023</p>
                                </div>
                            </div>
                        </div>
