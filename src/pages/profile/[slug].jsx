...
const UserProfile = ({
  ...
  const sell_token = async (tokenId, price) => {
          ...
          <div className="uni-banner pt-[200px]">
            <div className="container">
              <div className="uni-banner-text-area flex justify-center flex-col align-middle">
                ...
                <ul>
                  <li>
                    {signer_address.slice(0, 5) +
                      "..." +
                      signer_address.slice(38)}
                  </li>
                </ul>
              </div>
            </div>
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div className="blog-card blog-card-2 overflow-hidden">
                          ...
                          <div className="blog-text-area">
                            ...
                            <p>
                              Flight mode is {e.flight_mode} and flight type is{" "}
                              {e.flight_type}, this ticket is of{" "}
                              {e.airline_name} airlines.
                            </p>
                          </div>
